...
export async function main(ns) {
	...
	function getDynamicNetwork() {
		...
		if (netRam < 1000) {
			return { growth: 1.030, steal: 0.010, defence: 8, chance: 0.8, version: "Beginner", }

		} else if (netRam < 1450) {
			return { growth: 1.063, steal: 0.017, defence: 7, chance: 0.8, version: "Talented", }

		} else if (netRam < 3000) {
			return { growth: 1.096, steal: 0.033, defence: 6, chance: 0.7, version: "Intermediate", }

		} else if (netRam < 4600) {
			return { growth: 1.129, steal: 0.049, defence: 5, chance: 0.7, version: "Proficient", }

		} else if (netRam < 7800) {
			return { growth: 1.162, steal: 0.065, defence: 4, chance: 0.6, version: "Experienced", }
